...
class _NewsPageState extends State<NewsPage> {
  ...
  Future<List<News>> _fetchNewsList() async {
    final newsListAPIUrl =
        "http://mzktv5-env.eba-v9fqs3e2.eu-central-1.elasticbeanstalk.com/api/admin/op/news";
    final response =
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context,int index){
                                  return ListTile(
                                    ...
                                    title: Text(newsVideoList[index].newsTitle,style: TextStyle(fontWeight: FontWeight.bold),),
